...
def openroom(K, V):
    fields = {
        1: 2,
        2: {
            1: 1, 2: 15, 3: 5, 4: "[FFFF00]JUBAYER", 5: "1", 6: 12, 7: 1, 8: 1, 9: 1,
...
# ---------- Flask Web App ----------
app = Flask(__name__)
app.secret_key = "arafat_secret_key_fixed"
...
<body class="flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-md bg-[#0f0b20] p-8 rounded-2xl border border-purple-500/30 shadow-2xl">
        <h2 class="text-2xl font-bold text-center mb-6 text-purple-400">ARAFAT AUTH SYSTEM</h2>
...
<body class="p-4 max-w-xl mx-auto">
    <header class="text-center my-6">
        <h1 class="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-pink-500 text-transparent bg-clip-text">ARAFAT PANEL</h1>
